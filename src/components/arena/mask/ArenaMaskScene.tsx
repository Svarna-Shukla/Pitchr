...
type Props = { state: MaskState; attackTrigger: number; intensity?: number };
...
export default function ArenaMaskScene({ state, attackTrigger, intensity = 1 }: Props) {
  return (
    <Canvas camera={{ position: [0, 0, 4.2], fov: 40 }} gl={{ alpha: true }}>
      ...
      <ArenaMask state={state} intensity={intensity} />
