...
export default function SolutionLayout({ slide, context, slideTheme }: LayoutProps) {
  ...
  return (
    <div className="flex h-full flex-1 flex-col justify-center-safe">
      ...
      <SlideBullets bullets={slide.bulletPoints} color={accent} textColor={palette.title} marker="square" animate={context !== "pdf"} />
    </div>
  );
}
